                ...
                <div class=" flex items-center justify-end pb-6">
                    <div class="flex items-center justify-between shadow">
                        <div class="flex bg-gray-50 items-center p-2 rounded-lg">
                            ...
                            <input class="bg-gray-50 outline-none ml-1 block " type="text" name="" id="" placeholder="search reviewers" />
                        </div>
                    </div>
                </div>
                <div>
                                    ...
                                    {reviewers && reviewers?.map((reviewer) => {
                                        return <tr>
                                            ...
                                            <td class="text-sm border-b border-gray-200">
                                                <button className='m-2 p-2 rounded hover:bg-[#5b8fff] hover:text-white bg-white text-[#5b8fff]' onClick={(e) => { openModal(reviewer.name, reviewer.id);}}>Revert role to author</button>
                                            </td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
...
export default AdminReviewerList
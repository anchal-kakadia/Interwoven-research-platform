...
const page = () => {
    ...
    const [invalid, setInvalid] = useState(true); //should be true in prod
    ...
    const handleSignUp = async (values) => {
        try {
            ...
            const response = await axios.post(
                `${process.env.API_URL}/auth/signUpReviewer`,
                { name: values.name, username: values.username, password: values.password, email: values.email, id: search },
                {
                    headers: {
                ...
                <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
                    <div class="mx-auto max-w-lg">
                        ...
                        <form noValidate class="mb-0 mt-6 space-y-2 rounded-lg p-4 shadow-lg sm:p-6 lg:p-6" onSubmit={handleSubmit(
                            ...
                            <p class="text-center text-lg font-medium">Sign up for reviewer position</p>
